<html>
<head><h1>Student Registration Form</h1></head>
<form action = "register.php" method = "POST">
<body><center><table border = "5" cellpadding = "10" cellspacing = "5">
<link rel="stylesheet" type="text/css" href="style.css">
	...
	<tr>
	<td><input type = "text" placeholder = "Benjamin Joseph" name = "first_name"></td>
	<td><input type = "text" placeholder = "Miguel" name = "middle_name"></td>
	<td><input type = "text" placeholder = "Longakit" name = "last_name"></td>
	</tr>
